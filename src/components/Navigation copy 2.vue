        ...
        <ul class="space-y-2 font-medium">
           ...
           <li>
              ...
              <ul id="dropdown-pages" class="hidden py-2 space-y-2">
                <li>
                  <RouterLink to="/ping" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Ping</RouterLink>
                </li>
                <li>
                  <RouterLink to="/ping" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Trace</RouterLink>
                </li>
                <li>
                  <RouterLink to="/ping" class="flex items-center p-2 pl-11 w-full text-base font-normal text-gray-900 rounded-lg transition duration-75 group hover:bg-gray-100 dark:text-white dark:hover:bg-gray-700">Analyse</RouterLink>
                </li>
              </ul>
           </li>
           <li>
